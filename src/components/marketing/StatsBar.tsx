...
export function StatsBar() {
  ...
  return (
    <section 
      ref={sectionRef}
      className="relative py-16 md:py-8 bg-gradient-to-b from-white via-gray-50 to-white dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 overflow-hidden"
    >
