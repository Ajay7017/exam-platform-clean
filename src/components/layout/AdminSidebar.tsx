...
const navGroups = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Practice Exams', href: '/admin/practice-exams', icon: Dumbbell, color: 'text-lime-400' },
    ],
  },
  {
    title: 'Users',
...
function getActiveBgColor(colorClass: string): string {
  const map: Record<string, string> = {
    ...
    'text-lime-400': 'rgba(163,230,53,0.12), rgba(101,163,13,0.06)',
  };
...
function getGlowColor(colorClass: string): string {
  const map: Record<string, string> = {
    ...
    'text-lime-400': 'rgba(163,230,53,0.12)',
  };
